using MartiCase.API.Common.Attributes;
using MartiCase.API.Common.Middlewares;
using MartiCase.API.Common.Settings;
using MartiCase.API.Swagger;
            ...
            try
            {
                if (_appSettings.IsValid())
                {
                    ...
                    services.AddApiVersioning(
                        o =>
                        {
                            //o.Conventions.Controller<FileController>().HasApiVersion(1, 0);
